...
- O quality gate versionado executa unitários, jornadas Playwright e pgTAP em Postgres efêmero em pushes de `develop` e PRs para `main`; a proteção remota da `main` ainda precisa ser ativada após o primeiro check aparecer no GitHub.
