...
| Logs de Edge Functions/Supabase/Mercado Pago | Configuração e prazo pendentes de evidência do fornecedor | Não registrar token, e-mail, carteira, hash bruto ou payload integral | Segurança e observabilidade mínima |
