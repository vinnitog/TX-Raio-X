...
gratuitas por navegador/perfil e origem, e desbloqueio beta por R$ 4,99.

As próximas evoluções estão registradas em `ROADMAP.md`.
...
duas análises gratuitas, paywall e desbloqueio beta local. O botão de desbloqueio
...
tokens podem não aparecer nesta primeira versão. O beta desbloqueado aumenta a
...
pagamentos aprovados de R$ 4,99 vinculados a este produto.
...
O desbloqueio é salvo no `localStorage`, mas nunca é concedido somente pelo
